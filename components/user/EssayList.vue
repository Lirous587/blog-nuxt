  ...
  <div class="grid grid-cols-1 lg:grid-cols-2 gap-3">
    <div v-for="item in list" :key="item.id">
      ...
      >
        ...
        <div
          v-if="item.ifRecommend || item.ifTop"
          class="absolute top-0 left-0 w-[40px] h-[40px] flex items-center justify-center bg-gradient-to-r dark:from-gray-800 dark:to-gray-800 shadow-sm rounded-br-3xl"
          :class="
            item.ifTop
