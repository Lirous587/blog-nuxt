<template>
  <div>
    <div
      class="fixed flex w-screen h-screen justify-center items-center flex-col z-[999] overflow-hidden dark:bg-slate-900"
    >
      <div
    ...
    <div
      class="fixed h-screen left-0 w-[60vw] z-[999] overflow-hidden bg-gray-600 dark:bg-slate-900 transition-transform duration-500 ease-in-out"
      :class="!ifLoad ? '-translate-x-full' : ''"
    ></div>
    <div
      class="fixed h-screen right-0 w-[60vw] z-[999] overflow-hidden bg-gray-600 dark:bg-slate-900 transition-transform duration-500 ease-in-out"
      :class="!ifLoad ? 'translate-x-full' : ''"
    ></div>
  </div>
</template>
...
<script setup>
const ifLoad = defineModel("ifLoad", { type: Boolean, default: false });
</script>
